          ...
          <c:forEach var="EachList" items="${list}" varStatus="status">
            <div class="entry-item">
              ...
              <div class="entry-title">
                <h2>
                  <a href="blog-single.html"><c:out value="${EachList.title}" /></a>
                </h2>
              </div>
              <ul class="entry-meta">
                <li class="entry-date">
                  <a href="#"><fmt:formatDate value="${EachList.regDate}" pattern="yyyy-MM-dd"/></a>
                </li>
                <li class="entry-author">
                  by <a href="blog-single.html"><c:out value="${EachList.writer}" /></a>
                </li>
                <li>
                  <a href="blog-single.html" class="entry-comments">댓글</a>
                </li>                
                <li class="entry-category">
                  <a href="#"><c:out value="${EachList.viewCount}" /></a>
                </li>
              </ul>
