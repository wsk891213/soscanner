	...
	<div class="main-wrapper-onepage main oh">
		...
		<div>
			...
			<div class="boxStyle question">
				<div class="questArea">
					<strong> <img src="/resources/images/tit_quest.gif"
						alt="자주 찾는 질문" />
					</strong>
				</div>
				...
				<form action="/faq/faq" method="get">
					<div class="inpArea">
						<input type="text" class="textInp01" name="searchValue"
							id="searchValue"> <input type="submit" class="btn"
							value="">
						<div style="display: none">
							<img class="btn-img" src="/resources/images/btn_grSearch.gif" />
						</div>
					</div>
				</form>
					...
					<table>
						...
						<c:forEach var="faq" items="${faq}">
							<tr>
								...
								<td class="ask" id="ask${faq.faqNo}"
									onclick="test(${faq.faqNo})"><c:out value="${faq.content}" /></td>
							</tr>
